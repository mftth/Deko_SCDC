...
row_var_baron = apply(baron_cnt, FUN = var, MARGIN = 1)
baron_cnt = baron_cnt[row_var_baron != 0,]
baron_cnt = baron_cnt[rowSums(baron_cnt) >= 1,]
...
row_var_seger = apply(segerstolpe_cnt, FUN = var, MARGIN = 1)
segerstolpe_cnt = segerstolpe_cnt[row_var_seger != 0,]
segerstolpe_cnt = segerstolpe_cnt[rowSums(segerstolpe_cnt) >= 1,]
...
row_var_lawlor = apply(lawlor_dt, FUN = var, MARGIN = 1)
lawlor_dt = lawlor_dt[row_var_lawlor != 0,]
lawlor_dt = lawlor_dt[rowSums(lawlor_dt) >= 1,]
...
saveRDS(ensemble_exocrine_dec_res, file = "~/Praktikum/decon_res2/ensemble_exocrine_dec_res2.RDS")
...
saveRDS(baron_exocrine_dec_res, file = "~/Praktikum/decon_res2/baron_exocrine_dec_res2.RDS")
...
saveRDS(segerstolpe_exocrine_dec_res, file = "~/Praktikum/decon_res2/segerstolpe_exocrine_dec_res2.RDS")
...
# no change
saveRDS(lawlor_exocrine_dec_res, file = "~/Praktikum/decon_res2/lawlor_exocrine_dec_res2.RDS")
